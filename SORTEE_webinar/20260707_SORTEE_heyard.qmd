---
title: Lotteries and innovations in research funding allocation <br>
subtitle: SORTEE webinar -- July 07, 2026
...
<!-- This webinar shows how research on research can inform better funding decision-making. I will share real-world examples from my work as a statistician at the Swiss National Science Foundation (SNSF) and my current research on funding and evaluation. -->
...
# Who am I \Smiley{} 
\textcolor{green!40!black}{\textbf{Slides}: https://osf.io/ujdah}
...
-   2022--2025: Postdoctoral fellow in meta-research at Center for Reproducible Science, UZH 

-   Since 2025: Senior Researcher at Center for Reproducible Science **and Research Synthesis**, UZH 

\pause
-   Research focused on reproducibility, Open Science & research funding allocation systems 

-   Training in good research practices 
\pause 
...
plot_data %>% 
  ...
  geom_jitter(size = 1.5, height = .15, aes(color = proposal_coi), #color = "#A3A3A3",
              width = .2, alpha = .6) + 
  geom_point(data = plot_data %>% select(order, avg) %>% distinct(),
             aes(y = avg), col = "#5A1542", size = 3, pch = 15) +
  theme_classic() + 
  scale_color_manual(values = c("#A3A3A3", "black")) +
  labs(y = "Assessor Vote", x = "Ordered proposal") +
  scale_y_continuous(breaks = 1:6,
...
\vspace{-.25cm}
```{r, out.width=".8\\linewidth", include=TRUE, fig.align="center", echo=FALSE}
knitr::include_graphics("img/motivations_lottery.png")
```

\url{https://doi.org/10.1093/reseval/rvac022}

# Effect of funding by lottery

\vspace{-.25cm}
```{r, out.width=".8\\linewidth", include=TRUE, fig.align="center", echo=FALSE}
knitr::include_graphics("img/effect_lottery.png")
```
...
Available from github: [rachelhey.github.io/talks/SORTEE_webinar](rachelhey.github.io/talks/SORTEE_webinar).

Please cite as: R Heyard "Lotteries and innovations in research funding allocation", SORTEE webinar, 2026 [osf.io/ujdah](https://osf.io/ujdah).
